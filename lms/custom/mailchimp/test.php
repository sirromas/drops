...
$subject = 'Mailchimp Sample Campaign #6';
...
$users   = array('sirromas@gmail.com', 'sirromas@outlook.com');

// Lets Create New Campaign!
//$m->prepare_campaign($subject,$content,$users);
//$m->send_mailchimp_campaigns();

$path=$_SERVER['DOCUMENT_ROOT'];
echo "Document root: $path";